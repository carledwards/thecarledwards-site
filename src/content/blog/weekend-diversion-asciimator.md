...
With the help of AI, I took one of those little diversions and built a new utility I’m calling [Asciimator](https://asciimator.com). It’s a drawing tool for creating ASCII-based graphics and screen mockups. You can check out the source on [GitHub](https://github.com/carledwards/Asciimator).
...
- [foxpro-js](https://github.com/carledwards/foxpro-js)
- [retro-dos-framework](https://github.com/carledwards/retro-dos-framework)

Those projects helped shape the foundation for how I thought about interaction, layout, and flow in Asciimator.

Now I get to jump back to my original path and see if I can bring [GitPro](https://github.com/carledwards/GitPro) to life.
